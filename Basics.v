...
Proof.
  intros [] []; simpl; intros; try assumption; reflexivity.
Qed.
(** [] *)
...
(** When Coq checks this definition, it notes that [plus'] is
    ...
    particular, it liverged.gguarantees that every function that can be defined
...
Proof. intros f h b. repeat rewrite -> h. reflexivity. Qed.
...
Theorem negation_fn_applied_twice :
  forall (f : bool -> bool),
    ...
    forall (b : bool), f (f b) = b.
Proof. intros f h []; repeat rewrite -> h; reflexivity. Qed.
(** [] *)
...
Theorem andb_eq_orb :
  ...
  (andb b c = orb b c) ->
  b = c.
Proof. intros [] []; simpl; intros h; try rewrite -> h; reflexivity. Qed.
(** [] *)
...
Proof. reflexivity. Qed.
Example test_bin_incr2 : bin_to_nat (incr (incr (T Z))) = 2.
Proof. reflexivity. Qed.
Example test_bin_incr3 : bin_to_nat (T (incr (incr Z))) = 4.
Proof. reflexivity. Qed.
Example test_bin_incr4 : bin_to_nat (T (T (incr Z))) = 4.
Proof. reflexivity. Qed.
Example test_bin_incr5 : bin_to_nat (T (T (T (ST Z)))) = 8.
Proof. reflexivity. Qed.
