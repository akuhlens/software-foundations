...
Theorem silly_ex :
     ...
     evenb 3 = true ->
     oddb 4 = true.
Proof. intros impl eq1. apply eq1. Qed. 
(** [] *)
...
Example 
trans_eq_example : forall (a b c d e f : nat),
     [a;b] = [c;d] ->
     [c;d] = [e;f] ->
     [a;b] = [e;f].
Proof.
...
Example trans_eq_exercise : forall (n m o p : nat),
     ...
     (n + p) = m ->
     (n + p) = (minustwo o).
Proof. intros n m o p eq1 eq2. apply trans_eq with m; repeat assumption.
Qed.
(** [] *)
...
(* inversion = discriminate + injective *)
...
Example inversion_ex3 : forall (X : Type) (x y z : X) (l j : list X),
  ...
  y :: l = x :: j ->
  x = y.
Proof. intros X x y z l j H1 H2. inversion H1. inversion H2. symmetry. assumption.
Qed.
(** [] *)
...
Example inversion_ex6 : forall (X : Type)
  ...
  y :: l = z :: j ->
  x = z.
Proof. intros X x y z l j h1 h2. discriminate. Qed.
